...
const Dropzone = (function(_React$Component) {
  ...
  function Dropzone(props, context) {
    ...
    const _this = _possibleConstructorReturn(
      this,
      (Dropzone.__proto__ || Object.getPrototypeOf(Dropzone)).call(this, props, context)
    )
  ...
  _createClass(Dropzone, [
    {
      ...
      value: function componentDidMount() {
        const preventDropOnDocument = this.props.preventDropOnDocument
    ...
    },
    {
      ...
      value: function onDragLeave(evt) {
        ...
        this.dragTargets = this.dragTargets.filter(
          el => el !== evt.target && _this2.node.contains(el)
        )
      ...
      value: function onDrop(evt) {
        ...
        fileList.forEach(file => {
          ...
          if (
            ...
            fileMatchSize(file, _this3.props.maxSize, _this3.props.minSize)
          ) {
        ...
        if (!multiple) {
          ...
          rejectedFiles.push(..._toConsumableArray(acceptedFiles.splice(1)))
        }
      ...
      value: function onFileDialogCancel() {
        ...
        if (this.isFileDialogActive) {
          setTimeout(() => {
            ...
            const files = _this4.fileInputEl.files
    ...
    },
    {
      ...
      value: function render() {
        ...
        let acceptStyle = rest.acceptStyle,
          ...
          style = rest.style,
          props = _objectWithoutProperties(rest, [
            'acceptStyle',
            'activeStyle',
            'className',
            'disabledStyle',
        ...
        let appliedStyle = _extends({}, style)
        ...
        let acceptedFiles = props.acceptedFiles,
          ...
          divProps = _objectWithoutProperties(props, [
            'acceptedFiles',
